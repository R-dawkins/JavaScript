...
console.log(`박스오피스 순위 : ${koRes[0].rank}위`);
console.log(`개봉일 : ${koRes[0].openDt}`);
console.log(`영화 제목 : ${koRes[0].movieNm}`);
console.log(`누적 관객수 : ${koRes[0].audiAcc}명`);
console.log(`누적 매출액 : ${koRes[0].salesAcc}원`);
console.log(`--------------------------------------`);
console.log(`박스오피스 순위 : ${koRes[0].rank}위
개봉일 : ${koRes[0].openDt}
영화 제목 : ${koRes[0].movieNm}
누적 관객수 : ${koRes[0].audiAcc}명
누적 매출액 : ${koRes[0].salesAcc}원
`);
...
${koRes.map(item=>
  `
<div class="pBox">
    <h2>영화 제목 : ${item.movieNm}</h2>
    <p class ="rank">박스오피스 순위 : ${item.rank}위</p>
    <p class ="date">개봉일 : ${item.openDt}</p>
    <p class ="dayAcc">일일 관객수 : ${item.audiCnt}명</p>
    <p class ="allAcc">누적 관객수 : 총 ${item.audiAcc}명</p>
    <p class ="allSales">누적 매출액 : ${item.salesAcc}원</p>
  </div>
  `).join('\n')}
  </div>
  `)
